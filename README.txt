...
It is organized into two files (located into the nestedness folder):
...
- to ease the understanding, for each implemented metrics the article in which it was introduced is listed, which often displays a comprehensive explanation. In addition, at the end of the file some useful review articles are reported
